...
function Contact() {
    ...
    // Fonction de validation pour vérifier si tous les champs sont remplis
        ...
        <div className='michroma-text h-full flex flex-col justify-center items-center pb-10'>
            ...
            <div className="form w-[80vw] lg:w-[62vw] flex flex-col items-center "> 
                ...
                <div className="flex justify-center items-center mb-7">
                    ...
                    <div className="mx-3 lg:mx-7"><span className="text-[#85EA26] text-[15px]">ou</span></div>
                    <Separator className="bg-[#85EA26] !w-[20vw]" />
                </div>
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4 w-full mx-auto">
                    ...
                    <button
                        type="submit"
                        className={`p-2 bg-[#85EA26] text-white hover:bg-[#6ea739] ${!isFormValid ? 'opacity-50 cursor-not-allowed' : ''}`}
