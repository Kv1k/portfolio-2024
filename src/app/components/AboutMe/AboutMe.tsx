...
function AboutMe() {
  return (
    <>
      <div className="inner-section h-[98vh] michroma-text">
                 
        <div className='h-[64%] bg-transparent flex flex-col justify-end items-start pl-[45vw]'>
          <div className="bg-slate-500 w-[250px] h-[330px] mb-[30px]" />
        </div>
        <div className='  flex flex-col items-center'>
          <div className="bg-white w-[92vw] h-[1.2px]"/>
        </div>
      
        <h3 className="absolute mt-[20px] left-[4vw] p-0 text-[16px]">
          About me
        </h3>
        <div className='flex justify-start items-start  w-[100%]  h-[32%] pl-[45vw] mt-[25px] '>
        
          <p className=' w-[323px] h-[180px] text-[12px] whitespace-normal break-words'>
          ...
          <p className=' ml-[60px] w-[323px]  h-[180px] text-[12px] whitespace-normal break-words'>
      ...
      <div className="inner-section  h-auto  py-20 michroma-text">
        ...
        <h3 className="mt-[20px] ml-[4vw] p-0 text-[16px] ">
          Skills
        </h3>
        <div className="flex w-full justify-center items-center mt-[45px]">
          <div className="flex w-[85%]  py-8  px-8 border border-[#85EA26] ">
            <div className='w-[95%] grid grid-cols-6 gap-y-8 gap-x-4 items-center justify-center '>
        ...
        <div className="flex w-full justify-center items-center mt-[45px]">
          <div className="flex w-[85%]  py-8  px-8 border border-[#85EA26] ">
            <div className='w-[95%] grid grid-cols-5 gap-y-8 gap-x-4 items-center justify-center '>
              <div className='flex justify-center items-center flex-col'>
                <FaSymfony size={50}/>
                <p>Symfony</p>
              </div>
        ...
        <div className="flex w-full justify-center items-center mt-[45px]">
          <div className="flex w-[85%]  py-8  px-8 border border-[#85EA26] ">
            <div className='w-[95%] grid grid-cols-4 gap-y-8 gap-x-4 items-center justify-center '>
              <div className='flex justify-center items-center flex-col'>
